package com.hb.springboot.sms.utils;
...
public class StringUtils extends org.apache.commons.lang.StringUtils {
   ...
   //
   //   return getSerialNumber(prefix, Integer.parseInt(last), lastLength);
   //}
   //
   ///**
   ...
   //}
   //
   //public static String jscb(String cbName ,String data ) {
   //   return StringUtils.areNotEmpty( cbName ) ? cbName+"("+data+");": data;
   //}
}
