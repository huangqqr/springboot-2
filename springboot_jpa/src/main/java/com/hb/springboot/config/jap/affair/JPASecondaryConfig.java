package com.hb.springboot.config.jap.affair;
...
@EnableJpaRepositories(basePackages = "com.hb.springboot.dao.jpa2",
...
public class JPASecondaryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean masterEntityManager() throws Throwable {
        ...
        //这里要修改成你的数据源的扫描包
        entityManager.setPackagesToScan("com.hb.springboot.dao.jpa2");
